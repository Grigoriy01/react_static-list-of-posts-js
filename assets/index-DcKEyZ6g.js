...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>{const{name:t,email:i,body:n}=e;return R.jsxs("div",{className:"CommentInfo",children:[R.jsxs("div",{className:"CommentInfo__title",children:[R.jsx("strong",{className:"CommentInfo__name",children:t})," by ",R.jsx("a",{className:"CommentInfo__email",href:`mailto:${i}`,children:i})]}),R.jsx("div",{className:"CommentInfo__body",children:n})]})},Lc=({comments:e})=>{const t=R.jsxs(R.Fragment,{children:[R.jsx("hr",{}),R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]});return e.length===0?t:R.jsx("div",{className:"CommentList",children:e.map(i=>R.jsx(Pc,{comment:i},i.id))})},Mc=({user:e})=>R.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Tc=({post:e})=>{const{user:t,comments:i}=e;return R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e.title}),R.jsxs("p",{children:[" Posted by  ",t&&R.jsx(Mc,{user:t})]})]}),R.jsx("p",{className:"PostInfo__body",children:e.body}),R.jsx(Lc,{postId:e.id,comments:i})]})},Rc=({posts:e})=>R.jsx("div",{className:"PostList",children:e.map(t=>R.jsx(Tc,{post:t},t.id))});function Dc(e){return zc.filter(t=>t.postId===e)||null}function jc(e){return Nc.find(t=>t.id===e)}const Oc=Cc.map(e=>({...e,user:jc(e.userId),comments:Dc(e.id)})),Fc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx(Rc,{posts:Oc})]});em(document.getElementById("root")).render(R.jsx(Fc,{}));
